...
export const SkillCard = ({ name, image }) => {
  return (
    <div class="relative flex flex-col justify-center items-center w-full h-full border-2 border-[#00FFA7]/75 rounded-xl hover:bg-[#00FFA7]/75 duration-300 ease-in-out">
