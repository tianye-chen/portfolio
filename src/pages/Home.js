...
export const Home = () => {
  return (
    <div
      name="home"
      class="flex-shrink-0 w-screen min-h-screen px-8 overflow-hidden border"
    >
      <div class="flex flex-row items-center min-h-screen">
        ...
        <div>
          <h1 class="text-7xl font-thin text-slate-400">
            Hello, I'm{" "}
            <span class="text-white font-normal border-b-4 border-[#00FFA7] text-8xl">
              Tianye Chen
            </span>
            ,
          </h1>
          ...
          <div class="flex flex-row gap-2 mt-3 ml-[0.2rem] w-min">
            <div class="flex flex-row gap-2 group/email">
              ...
              <p class="text-slate-400 group-hover/email:text-white font-thin">
                tianyecf@gmail.com
              </p>
            </div>
            <Files
        ...
        <div class="w-[50%] absolute right-0 translate-x-[8%]">
